...
job_copy_option_default = {
    ...
    CopyEwsOptionsKey.blank_page_suppression: False
}
...
job_copy_applying_pages_per_sheet_four_right_then_down={
CopyEwsOptionsKey.pages_per_sheet: PagesPerSheet.four_right_then_down
}

job_copy_applying_pages_per_sheet_four_down_then_right={
CopyEwsOptionsKey.pages_per_sheet: PagesPerSheet.four_down_then_right
}

job_copy_applying_add_page_borders_default_line_border={
CopyEwsOptionsKey.add_page_border: True
}
...
job_copy_applying_booklet_format_on={
CopyEwsOptionsKey.booklet_format: True
}

job_copy_applying_borders_on_each_page_on={
CopyEwsOptionsKey.borders_on_each_page: True
}
...
job_copy_option_combi_blankPageSuppression_enabled={
CopyEwsOptionsKey.blank_page_suppression: True
}

job_copy_option_combi_staple_leftTwoPoints={
CopyEwsOptionsKey.finisher_staple: Staple.leftTwoPoints
}

job_copy_option_combi_punch_rightTwoPointDin={
CopyEwsOptionsKey.finisher_punch: Punch.rightTwoPointDin
}

job_copy_option_combi_fold_vFold={
CopyEwsOptionsKey.finisher_fold: Fold.copyVFoldOption
}

job_copy_option_combi_booklet_saddleStitch={
CopyEwsOptionsKey.finisher_booklet: BookletMaker.saddleStitch
}
...
job_copy_applying_with_diffrent_combination_papersize_papertype_combi_one={
    CopyEwsOptionsKey.paper_size: PaperSize.Letter_8_5x11_in_ ,
    CopyEwsOptionsKey.paper_type : PaperType.Plain     
}

job_copy_applying_with_diffrent_combination_papersize_papertype_combi_two={
    CopyEwsOptionsKey.paper_size: PaperSize.Legal_8_5x14_in_ ,
    CopyEwsOptionsKey.paper_type : PaperType.Plain     
}
...
def excepted_reboot_settings_from_actual_cdm(ews):
    """
    ...
    if imageModifications_settings.get("pagesPerSheet"):
        validated_settings["pipelineOptions"]["imageModifications"]["pagesPerSheet"] = imageModifications_settings["pagesPerSheet"]
    if imageModifications_settings.get("numberUpPresentationDirection"):
        validated_settings["pipelineOptions"]["imageModifications"]["numberUpPresentationDirection"] = imageModifications_settings["numberUpPresentationDirection"]
    if imageModifications_settings.get("imageBorder"):
        validated_settings["pipelineOptions"]["imageModifications"]["imageBorder"] = imageModifications_settings["imageBorder"]
    if imageModifications_settings.get("bookletFormat"):
        validated_settings["pipelineOptions"]["imageModifications"]["bookletFormat"] = imageModifications_settings["bookletFormat"]
    if imageModifications_settings.get("autoTone"):
        validated_settings["pipelineOptions"]["imageModifications"]["autoTone"] = imageModifications_settings["autoTone"]
    if imageModifications_settings.get("autoToneLevel"):
        validated_settings["pipelineOptions"]["imageModifications"]["autoToneLevel"] = imageModifications_settings["autoToneLevel"]
    if imageModifications_settings.get("autoPaperColorRemoval"):
        validated_settings["pipelineOptions"]["imageModifications"]["autoPaperColorRemoval"] = imageModifications_settings["autoPaperColorRemoval"]
    if imageModifications_settings.get("autoPaperColorRemovalLevel"):
        validated_settings["pipelineOptions"]["imageModifications"]["autoPaperColorRemovalLevel"] = imageModifications_settings["autoPaperColorRemovalLevel"]
        
    if print_setting.get("stapleOption"):
        validated_settings["dest"]["print"]["stapleOption"] = print_setting["stapleOption"]
    if print_setting.get("punchOption"):
        validated_settings["dest"]["print"]["punchOption"] = print_setting["punchOption"]
    if print_setting.get("foldOption"):
        validated_settings["dest"]["print"]["foldOption"] = print_setting["foldOption"]
    if print_setting.get("bookletMakerOption"):
        validated_settings["dest"]["print"]["bookletMakerOption"] = print_setting["bookletMakerOption"]
...
def applying_with_different_combinations_two_expected_settings_from_actual_cdm(ews):
    """
    Check data configuration with cdm
    @param: actual_settings ->  for checking field, please refer to bottom sample data
    @return:
...
def applying_with_different_combinations_four_expected_settings_from_actual_cdm(ews):
    """
    Check data configuration with cdm
    @param: actual_settings ->  for checking field, please refer to bottom sample data
    @return:
...
def applying_with_different_combinations_five_expected_settings_from_actual_cdm(ews):
    """
    Check data configuration with cdm
    @param: actual_settings ->  for checking field, please refer to bottom sample data
    @return:
