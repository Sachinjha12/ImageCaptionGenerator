...
$$$$$_BEGIN_TEST_METADATA_DECLARATION_$$$$$
    ...
    +name:test_copy_ui_adf_two_2_two_test
    +test:
        +title:test_copy_ui_adf_two_2_two_test
        +guid:ead1c59f-5281-4195-9a58-e0a059351ef3
        +dut:
            +type:Simulator
...
"""
def test_copy_ui_adf_two_2_two_test(job, tray, device, udw, cdm, spice):
    try:
